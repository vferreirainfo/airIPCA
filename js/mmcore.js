...
if (typeof(window.location.search)=='undefined' || window.location.search.toLowerCase().indexOf('mvt=false')==-1) {
...
// POC Tealium Tag-Management Script:
// V1:
	/*
	var utag_data = {};
	(function(a,b,c,d){
		a='//tags.tiqcdn.com/utag/lufthansa/main/prod/utag.js';
...
// V2:
	document.write('<scr'+'ipt type="text/javascript" src="//tags.tiqcdn.com/utag/lufthansa/main/prod/utag.js"><\/scr'+'ipt>');