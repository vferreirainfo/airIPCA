<?php
	...
	if ( $tmq_pagesidebar == '' || empty( $tmq_pagesidebar ) ) {
		...
		if ( function_exists( 'ot_get_option' ) ) {
		   ...
		   if ( is_product() ) {
				$tmq_pagesidebar = ot_get_option( 'tmq_product_right_sidebar' );					   
		   } elseif ( is_product_category() ) {
				$tmq_pagesidebar = ot_get_option( 'tmq_woo_category_right_sidebar' );					   
		   } else {
				$tmq_pagesidebar = ot_get_option( 'tmq_woo_right_sidebar' );
		   }
